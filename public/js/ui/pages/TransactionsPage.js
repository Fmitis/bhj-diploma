...
class TransactionsPage {
   ...
   * */
  formatDate(date){
    const DMY = new Date(date).toLocaleString('ru-RU', { day: '2-digit', month: 'long', year: 'numeric' });
    const HM = new Date(date).toLocaleString('ru-RU', { hour: 'numeric', minute: 'numeric' });
    return `${DMY} в ${HM}`;
  }
